        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="flex gap-2 mb-1">
            <input
              ...
              {...register('firstname')}
              className={`bg-[#eeeeee] rounded outline-none px-4 py-2 border w-1/2 text-lg placeholder:text-sm ${
                errors.firstname ? 'border-red-500' : touchedFields.firstname ? 'border-green-500' : ''
              }`}
            />
            ...
            <input
              ...
              {...register('lastname')}
              className={`bg-[#eeeeee] rounded px-4 outline-none py-2 border w-1/2 text-lg placeholder:text-sm ${
                errors.lastname ? 'border-red-500' : touchedFields.lastname ? 'border-green-500' : ''
              }`}
            />
          ...
          <input
            ...
            {...register('email')}
            className={`bg-[#eeeeee] mb-5 rounded px-4 outline-none py-2 border w-full text-lg placeholder:text-sm ${
              errors.email ? 'border-red-500' : touchedFields.email ? 'border-green-500' : ''
            }`}
          />
